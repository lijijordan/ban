...
//        TradeCounter.QUEUE_SIZE = 60 * 2 * 30 * 2;
    ...
    private void statistic(String platformA, String platformB, String symbol, int queueSize) {
        ...
        StatisticRecordDto statisticRecordDto = this.tradeRecordService.queryAndStatisticTradeRecord(new Date());
    ...
    public void run() throws ParseException {
        ...
        Date start = format.parse("2018/07/10 00:00:00");
        Date end = format.parse("2018/07/16 12:00:00");
...
//        run(start, end, 12000, ETH_USDT);
        this.split = 1; this.wareHouseDiff = 0.007;

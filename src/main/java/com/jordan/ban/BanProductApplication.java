...
//        productApplication.diffTask(Constant.LTC_USDT, Huobi.PLATFORM_NAME, Fcoin.PLATFORM_NAME, 2000);
        ...
        // fcoin vs gateio
//        productApplication.diffTask(Constant.ETH_USDT, Gateio.PLATFORM_NAME, Fcoin.PLATFORM_NAME, 2000);
...
//        productApplication.diffTask(Constant.LTC_USDT, Dragonex.PLATFORM_NAME, Fcoin.PLATFORM_NAME, 2000);
        ...
        productApplication.diffTask(Constant.EOS_USDT, Dragonex.PLATFORM_NAME, Fcoin.PLATFORM_NAME, 2000);
